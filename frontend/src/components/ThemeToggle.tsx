...
export default function ThemeToggle({
  ...
  return (
    <button
      onClick={onToggle}
      className={`relative ${s.track} rounded-full cursor-pointer overflow-hidden border-0 p-0 outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2`}
    ...
    >
        ...
        {!isDark && (
          <>
            <motion.div
              ...
              style={{ width: 10, height: 5, top: "20%", left: "55%" }}
            ...
            <motion.div
              ...
              style={{ width: 8, height: 4, bottom: "25%", left: "60%" }}
            ...
            <motion.div
              ...
              style={{ width: 12, height: 5, top: "50%", left: "50%" }}
      ...
      <AnimatePresence>
        {isDark && (
          <motion.div
            className="absolute left-1 top-1/2 -translate-y-1/2 pointer-events-none z-20"
            initial={{ opacity: 0 }}
          ...
          >
            <div
              ...
              style={{ width: 3, height: 3, left: 10, top: -2 }}
            />
            <div
              className="absolute rounded-full bg-gray-400"
              style={{ width: 2, height: 2, left: 14, top: 3 }}
            />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      {/* Knob */}
      <motion.div
        className={`absolute top-1 ${s.knob} rounded-full shadow-lg flex items-center justify-center z-10`}
        animate={{
