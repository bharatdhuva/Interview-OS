...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (<ToastPrimitives.Viewport ref={ref} className={cn("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-0 sm:left-[50%] sm:-translate-x-[50%] sm:bottom-auto sm:right-auto sm:flex-col md:max-w-[420px]", className)} {...props}/>));
