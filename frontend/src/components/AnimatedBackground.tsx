...
const AnimatedBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      >
        <motion.path
          d="M40 10 L70 10 L85 36 L70 62 L40 62 L25 36 Z"
          fill="none"
        ...
        />
        <motion.path
          d="M70 62 L100 62 L115 88 L100 114 L70 114 L55 88 Z"
          fill="none"
        ...
        />
        <motion.path
          d="M10 62 L40 62 L55 88 L40 114 L10 114 L-5 88 Z"
          fill="none"
      ...
      <svg
        className="absolute"
        style={{ top: "55%", right: "5%", width: 80, height: 200 }}
      >
        {[0, 1, 2, 3, 4].map((i) => (
          <motion.rect
            key={i}
            ...
            height="2"
            rx="1"
            fill={`rgba(99,102,241,${0.2 - i * 0.03})`}
            initial={{ opacity: 0, x: -10 }}
            animate={{ opacity: [0, 0.6, 0], x: [0, 10, 20] }}
            transition={{
              duration: 2,
              delay: 1.5 + i * 0.3,
              repeat: Infinity,
